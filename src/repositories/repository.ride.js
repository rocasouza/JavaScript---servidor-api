...
async function Insert(passenger_user_id, pickup_address,
    ...
    // Note: The toISOString method returns the date in UTC, so we need to adjust it for the desired timezone.
    const dt = new Date().toISOString("pt-BR", {timeZone: "America/Sao_Paulo"}).slice(0, 10); // YYYY-MM-DD
